...
* Saving throws: STR +3, DEX +3, CON +1, INT +2, WIS +3, CHA +2
...
* Focus Points 2/2 and Uncanny Metabolism 1/1 on the live sheet. The Breath Weapon tracker returned an invalid negative value and must be confirmed at the table.
...
* Saving throws: STR -1, DEX +4, CON +0, INT +3, WIS +2, CHA +3
...
* Equipped on the live sheet: Leather armor, Shortbow, Shortsword, and Backpack.
* The Breath Weapon tracker returned an invalid negative value and must be confirmed at the table.
...
* Saving throws: STR +1, DEX +6, CON +2, INT +2, WIS +0, CHA +3
...
* Equipped on the live sheet: Cloak of Protection, Studded Leather, 2 Handaxes, Light Crossbow, Rapier, Crossbow Bolt Case, Backpack, Pouch, and 20 Bolts.
* Sheet/campaign mismatch: the live sheet currently returns no background, while the campaign file previously recorded a custom background. Preserve the campaign history and ask Erik to confirm the intended live-sheet background later.
...
* Saving throws: STR +1, DEX +1, CON +2, INT +0, WIS +1, CHA +5
* Notable skills: Arcana +2, History +2, Investigation +2, Survival +1
* Passive Perception 9
* Darkvision 120 ft.
* Adrenaline Rush: Bonus Action Dash and gain 2 temp HP, normally 2/Short Rest. The live tracker returned 0/0 and is not reliable.
* Relentless Endurance: drop to 1 HP instead of 0, 1/Long Rest
* Magical Cunning 1/1 on the live sheet.
* Spell Save DC 13 and Spell Attack +5.
* The live refresh did not return Throk's prepared spells, invocation selections, or pact-slot state. Table canon still establishes Eldritch Blast; confirm the rest on the sheet before relying on them.
* Feats returned by the live sheet: Healer and Dark Bargain. Healer requires a Healer's Kit, but no kit appeared in the returned equipped inventory.
* Equipped on the live sheet: Leather armor, 3 Handaxes, and a Sickle.
...
* Saving throws: STR +2, DEX +1, CON +3, INT +1, WIS +2, CHA +1
...
* Channel Divinity shows 2/2 on the live sheet. Stonecunning returned 0/0 even though its rules grant uses equal to Proficiency Bonus; confirm the tracker rather than treating 0/0 as authoritative.
* The current refresh did not return prepared-spell choices or spell-slot state, so confirm preparation and slots before relying on the spell list above.
...
* Floyd's awakening was tied to Glittervein, his fallen crew, the golden light that saved him, and the realization that he was spared to help dig others out.
