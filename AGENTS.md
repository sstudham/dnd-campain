# DnD agent entry point

Review unresolved entries in `SYSTEM-FEEDBACK.md` before maintenance work. Saving
feedback does not authorize implementing it. Follow the shared canon-save route
in `00-INSTRUCTIONS.md`; dictated "save to cannon" means the same request.

Read the current [00-INSTRUCTIONS.md](00-INSTRUCTIONS.md) first and [ARCHITECTURE.md](ARCHITECTURE.md) for host/recovery context. Its shared-save workflow applies to ChatGPT, Work, and Codex.
