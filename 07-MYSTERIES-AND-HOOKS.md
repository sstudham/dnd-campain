...
* Greenest is not yet confirmed as the settlement seen through the Observatory, and Lennithon is not confirmed as the distant departure omen. Preserve both unanswered identifications.
* September 9 D&D Beyond refresh unavailable: no exposed MCP and configured local helper directory absent. September 1 resources remain stale; confirm them before play. The existing Brother Kai claw-die conflict remains unresolved.
